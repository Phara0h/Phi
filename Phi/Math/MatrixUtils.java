...
public class MatrixUtils
{
    ...
    public static float[] lookAt(float[] eye, float[] look, float[] up)
    {
    	...
    	m[0]=u[0];m[1]=u[1];m[2]=u[2];m[3]=-dot(eye,u);
    	m[4]=v[0];m[5]=v[1];m[6]=v[2];m[7]=-dot(eye,v);
    	m[8]=n[0];m[9]=n[1];m[10]=n[2];m[11]=-dot(eye,n);
   ...
   // return: a 4x4 identity matrix
    ...
    public static float[] rotation(float angleDeg, float[] axis)
    {
    	...
    	if(d!=0)
    	{
    		...
    		rx[5] = a[2]/d;  rxt[5] = rx[5];
    		rx[6] = -a[1]/d; rxt[9] = rx[6];
    		rx[9] = a[1]/d;  rxt[6] = rx[9];
    		rx[10]= rx[5];  rxt[10] = rx[10];
