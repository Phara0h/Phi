 ...
 * @author phara0h
 */
public abstract class PhiShader
{
    ...
    public abstract void InitRender(GL3 gl, Application app);
    public abstract void Render(GL3 gl, Application app);
    public abstract void ReRender(GL3 gl, Application app,int width, int height);
}