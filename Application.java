...
public abstract class Application implements ProjectTemplate
{
    ...
    public ArrayList<PhiObject> phiObjects = new ArrayList<PhiObject>();
    ...
    public Application()
    {
        ...
        phiCanvas.addKeyListener(new ViewpointListener(phiViewpoint, this));
        phiCanvas.addMouseListener(new ViewpointListener(phiViewpoint, this));
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height)
    {
        ...
        phiShaders.get(0).ReRender(gl, this, width, height);
