 ...
 * @author phara0h
 */
public class PhiObjGeometry extends GLTriangulatedSurface
{
	...
	this.setColor(Color.white);
        this.size=9;
        this.vertices = new float[(size*3)*4];
        this.normals = new float[(size*3)*3];
        this.colors = new float[(size*3)*2];
    }
    ...
    {
        this.vertices = new float[(faces.size()*3)*4];
        this.normals = new float[(faces.size()*3)*3];
        this.texcoordinates = new float [(faces.size()*3)*2];
